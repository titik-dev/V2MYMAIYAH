...
export default function ThemeToggle() {
    ...
    if (!mounted) {
        // Render a placeholder matching the parent's adaptive color
        return (
            <div className="w-6 h-6 text-gray-900 dark:text-white opacity-50">
    ...
    return (
        ...
        >
            {theme === "dark" ? (
                ...
                // Use currentColor (inherit from parent) so it's black in light mode, white in dark mode
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M21.752 15.002A9.718 9.718 0 0118 15.75c-5.385 0-9.75-4.365-9.75-9.75 0-1.32.27-2.618.752-3.852A9.753 9.753 0 003 12c0 5.385 4.365 9.75 9.75 9.75a9.753 9.753 0 008.752-4.998z" />
                </svg>
            )}
